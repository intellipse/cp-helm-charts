...
== Intellipse Installation
[source,bash]
---
helm install --name kafka --namespace "kafka" --set cp-zookeeper.enabled=false --set cp-zookeeper.service-name="zookeeper-headless.zookeeper.svc.cluster.local:2181" --wait .
---
